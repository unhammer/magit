...
(define-transient-command magit-cherry-pick ()
  ...
  :value '("--ff")
  ["Switches"
   :predicate (lambda () (not (magit-sequencer-in-progress-p)))
  ...
  ["Actions"
   :predicate magit-sequencer-in-progress-p
...
(define-transient-command magit-am ()
  ...
  :value '("--3way")
  ["Switches"
   :predicate (lambda () (not (magit-am-in-progress-p)))
  ...
  ["Actions"
   :predicate magit-am-in-progress-p
...
(define-transient-command magit-rebase ()
  ...
  :man-page "git-rebase"
  ["Switches"
   :predicate (lambda () (not (magit-rebase-in-progress-p)))
  ...
  [:predicate (lambda () (not (magit-rebase-in-progress-p)))
   :description (lambda ()
                  (concat (propertize "Rebase " 'face 'transient-heading)
                          (propertize (or (magit-get-current-branch) "HEAD")
                                      'face 'magit-branch-local)
                          (propertize " onto" 'face 'transient-heading)))
   ("p" (lambda () (magit-get-push-branch))
    magit-rebase-onto-pushremote)
   ("u" (lambda () (magit-get-upstream-branch))
